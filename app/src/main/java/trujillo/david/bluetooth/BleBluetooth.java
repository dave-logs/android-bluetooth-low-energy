package trujillo.david.bluetooth;
...
import trujillo.david.bluetooth.interfaces.BleGattCallback;
import trujillo.david.bluetooth.interfaces.MacScanCallback;
import trujillo.david.bluetooth.interfaces.NameScanCallback;
import trujillo.david.bluetooth.interfaces.PeriodScanCallback;
import trujillo.david.bluetooth.models.ScanResult;
import trujillo.david.bluetooth.utils.BleLog;
...
public class BleBluetooth {
    ...
    public synchronized BluetoothGatt connect(ScanResult scanResult, boolean autoConnect, BleGattCallback callback) {
        ...
        final BluetoothDevice device = bluetoothAdapter.getRemoteDevice(scanResult.getDevice().getAddress());
        final BluetoothGatt gatt = device.connectGatt(context, autoConnect, coreGattCallback);
    ...
    private BleGattCallback coreGattCallback = new BleGattCallback() {
        ...
        public void onConnectSuccess(BluetoothGatt gatt, int status) {
            ...
            while (iterator.hasNext()) {
                ...
                //for (Object o : callbackHashMap.entrySet()) {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            } else if (newState == BluetoothGatt.STATE_DISCONNECTED) {// FIXME: 13/06/2017 WHY 8?
                connectionState = STATE_DISCONNECTED;
